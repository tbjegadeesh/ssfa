...
import { postRequest } from '../../../common/HttpMethods/FetchHttpMethods';
import {
  showErrorToast,
  showSuccessToast,
} from '../../../common/Toaster/toast';

// Define the structure for the signup form data
interface SignupData {
  fname: string;
  email: string;
  password: string;
  retypePassword: string; // Changed to match camelCase
}
...
const Register: React.FC = () => {
  ...
  const validateInput = (data: SignupData) => {
    const { fname, email, password, retypePassword } = data;
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await callRegister('/register', formData);
    } catch (error: any) {
  ...
  const callRegister = async (url: string, formData: SignupData) => {
    const response: any = await postRequest<SignupData, ResponseType>({
      url,
      formData,
    });
    if (response.success) {
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      name="fname" // Add name attribute for generic handler
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      type="password"
                      name="retypePassword" // Add name attribute for generic handler
                      placeholder="6+ Characters, 1 Capital letter"
